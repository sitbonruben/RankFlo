...
const SEO_NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/subscribers", label: "Subscribers", icon: "M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" },
    ],
  },
];
...
const ANALYTICS_NAV: NavSection[] = [
  ...
  },
  {
    title: "Content",
    items: [
      { href: "/analytics/content", label: "Content Performance", icon: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" },
    ],
  },
  {
    title: "Performance",
...
function AdminSidebarLink({ onNavigate, pathname }: { onNavigate: () => void; pathname: string }) {
  ...
  return (
    <div className="px-2 pb-1">
      ...
      >
        ...
        Admin
        {isActive && <span className="ml-auto h-1.5 w-1.5 rounded-full bg-accent shadow-[0_0_6px_rgba(57,255,20,0.5)]" />}
      </Link>
    </div>
  );
}
...
const MODE_ROOT: Record<AppMode, string> = {
  seo: "/overview",
  analytics: "/analytics",
  llms: "/llms",
};

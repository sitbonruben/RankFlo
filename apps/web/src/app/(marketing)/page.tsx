          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            ...
            <FadeUp>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <a href="https://docs.rankflo.io" className="inline-flex h-10 items-center gap-2 rounded-xl border border-gray-700 bg-gray-950 px-4 text-sm font-medium text-gray-300 hover:border-gray-600">
                  Self-hosting guide →
                </a>
              </div>
            </FadeUp>

      ...
      <div className="mx-auto max-w-wide px-6 py-16">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li><Link href="/features" className="hover:text-gray-700 dark:hover:text-gray-300">Changelog</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="mb-4 text-sm font-semibold text-gray-950 dark:text-white">Developers</h3>
            <ul className="space-y-2 text-sm text-gray-500">
              <li><a href="https://docs.rankflo.io" className="hover:text-gray-700 dark:hover:text-gray-300">Documentation</a></li>
              <li><a href="#" className="hover:text-gray-700 dark:hover:text-gray-300">API Reference</a></li>
              <li><a href="#" className="hover:text-gray-700 dark:hover:text-gray-300">Self-hosting</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li><a href="#" className="hover:text-gray-700 dark:hover:text-gray-300">Careers</a></li>
              <li><a href="#" className="hover:text-gray-700 dark:hover:text-gray-300">Contact</a></li>
            </ul>
          </div>
          <div>
            <h3 className="mb-4 text-sm font-semibold text-gray-950 dark:text-white">Legal</h3>
            <ul className="space-y-2 text-sm text-gray-500">
              <li><a href="#" className="hover:text-gray-700 dark:hover:text-gray-300">Privacy</a></li>
              <li><a href="#" className="hover:text-gray-700 dark:hover:text-gray-300">Terms</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 flex items-center justify-between border-t border-gray-200/50 pt-8 dark:border-gray-800/50">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="text-gray-400 transition-colors hover:text-gray-600 dark:text-gray-600 dark:hover:text-gray-400">

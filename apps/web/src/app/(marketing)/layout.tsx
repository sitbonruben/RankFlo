    ...
    <header className="fixed top-0 z-50 w-full border-b border-gray-800/50 bg-black/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-wide items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-7 md:flex">
          <Link href="/features" className="text-sm text-gray-400 transition-colors hover:text-white">Features</Link>
      ...
      {mobileOpen && (
        <div className="border-t border-gray-800/50 bg-black md:hidden">
          <nav className="flex flex-col px-6 py-4">
            <Link href="/features" onClick={() => setMobileOpen(false)} className="py-2.5 text-sm text-gray-300 font-medium hover:text-white">Features</Link>
            ...
            <p className="mt-3 pt-3 border-t border-gray-800/50 pb-1 text-[10px] font-semibold uppercase tracking-widest text-gray-600">Free Tools</p>

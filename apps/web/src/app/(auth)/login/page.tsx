  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-sm text-gray-500">Sign in to your RankFlo account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link href="/forgot-password" className="text-xs text-gray-600 hover:text-accent transition-colors">
              Forgot password?
            </Link>
          </div>
          <input
